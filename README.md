# MetaFrm.RemoteDesktop.Control

### .Net 10.0
[![build 10.0](https://github.com/MetaFrm/MetaFrm.RemoteDesktop.Control/actions/workflows/build_10.0.yml/badge.svg)](https://github.com/MetaFrm/MetaFrm.RemoteDesktop.Control/actions/workflows/build_10.0.yml)
[![NuGet version (MetaFrm.RemoteDesktop.Control.net10.0)](https://img.shields.io/nuget/v/MetaFrm.RemoteDesktop.Control.net10.0)](https://www.nuget.org/packages/MetaFrm.RemoteDesktop.Control.net10.0/)
[![NuGet downloads (MetaFrm.RemoteDesktop.Control.net10.0)](https://img.shields.io/nuget/dt/MetaFrm.RemoteDesktop.Control.net10.0)](https://www.nuget.org/packages/MetaFrm.RemoteDesktop.Control.net10.0/)
### .Net 9.0
...
```
<PackageReference Include="MetaFrm.RemoteDesktop.Control.net10.0" Version="x.x.x" />
```

You can also install via the .NET CLI with the following command:

```
dotnet add package MetaFrm.RemoteDesktop.Control.net10.0
```
